...
## @file NguyenTu-PHYS2211-Lab2-Long.py
...
# Initial Conditions
ball.pos = vector(0,0.000774,0)
ball.vel = vector(0,0,0)
#ball.vel = vector(0,-5,0) # What if? V_i = -5 (j-hat)
...
b = 0.0007 # gravity & air resistance (drag)
...
while t < 0.683000: # time of last observation
    ...
    arrowscale = 30 * visualScale # scalar for vector arrows' size
